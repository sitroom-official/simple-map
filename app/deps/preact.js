...
function toChildArray(children, callback, flattened) {
    ...
    if (children == null || typeof children == 'boolean') {
        ...
        flattened.push(
            callback(createVNode(null, children, null, null, children))
        )
        ...
        outer: if (typeof newType == 'function') {
            ...
            if (oldVNode._component) {
                ...
                if ('prototype' in newType && newType.prototype.render) {
                    newVNode._component = c = new newType(
                        newProps,
                        componentContext
                    ) // eslint-disable-line new-cap
                } else {
                    newVNode._component = c = new Component(
                        newProps,
                        componentContext
                    )
...
function render(vnode, parentDom, replaceNode) {
    ...
    diff(
        ...
        ((isHydrating ? parentDom : replaceNode || parentDom)._children =
            vnode),
        oldVNode || EMPTY_OBJ,
        EMPTY_OBJ,
        parentDom.ownerSVGElement !== undefined,
